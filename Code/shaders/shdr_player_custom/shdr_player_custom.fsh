...
uniform float avatarR;
uniform float avatarG;
uniform float avatarB;

uniform float avatarOutlineR;
uniform float avatarOutlineG;
uniform float avatarOutlineB;

uniform float avatarFaceR;
uniform float avatarFaceG;
uniform float avatarFaceB;

uniform float avatarShoeR;
uniform float avatarShoeG;
uniform float avatarShoeB;

const vec4 black_target = vec4(0.0,0.0,0.0,1.0);
const vec4 alpha_target = vec4(0.0,0.0,0.0,0.0);

vec4 red_target = vec4(avatarR, avatarG, avatarB, 1.0);    // Example RGBA
vec4 outline_red_target = vec4(avatarOutlineR, avatarOutlineG, avatarOutlineB, 1.0);    // Example RGBA
vec4 green_target = vec4(avatarFaceR, avatarFaceG, avatarFaceB, 1.0);  // Example RGBA
vec4 outline_green_target = vec4(avatarFaceR, avatarFaceG, avatarFaceB, 1.0);  // Example RGBA
vec4 blue_target = vec4(avatarShoeR, avatarShoeG, avatarShoeB, 1.0);   // Example RGBA
vec4 outline_blue_target = vec4(avatarShoeR, avatarShoeG, avatarShoeB, 1.0);   // Example RGBA
	
void main() {
	
	if (char_index == 0.0) {
        red_target = vec4(avatarR, avatarG, avatarB, 1.0);
        outline_red_target = vec4(avatarOutlineR, avatarOutlineG, avatarOutlineB, 1.0);
        green_target = vec4(avatarFaceR, avatarFaceG, avatarFaceB, 1.0);
        outline_green_target = vec4(avatarFaceR, avatarFaceG, avatarFaceB, 1.0);
        blue_target = vec4(avatarShoeR, avatarShoeG, avatarShoeB, 1.0);
        outline_blue_target = vec4(avatarShoeR, avatarShoeG, avatarShoeB, 1.0);
